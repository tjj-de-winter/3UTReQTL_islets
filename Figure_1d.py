...
plot_data = {
    '1': ['PDX1', '13:27926043', 'beta-cells', 'healthy'],
    '2': ['PCSK2', '20:17484568', 'alpha-cells', 'healthy'],
    '3': ['UNC5B', '10:71299601', 'delta-cells', 'healthy'],
    '4': ['MEIS2', '15:36891245', 'PP-cells', 'healthy'],
    '5': ['GP2', '16:20310145', 'acinar-cells', 'healthy'],
    '6': ['KRT80', '12:52170498', 'ductal-cells', 'healthy'],
    '7': ['NOTCH3', '19:15159772', 'stellate-cells', 'healthy'],
    '8': ['ANGPT2', '8:6500465', 'endothelial-cells', 'healthy']
}
...
for idx in plot_data:
    ...
    plot(gene, chromosome, variant, celltype, group, hex_to_rgb(color),nameout=f'figure1d_{idx}.png',fontsize=14)