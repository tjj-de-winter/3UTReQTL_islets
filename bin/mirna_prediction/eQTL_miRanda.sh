...
${p2miranda} ${mature_mirna_fasta_file} ${target_fasta_file} -sc ${score_threshold} -en ${energy_threshold} -scale ${scale_Z} -go ${gap_open} -ge ${gap_extend} -strict -out ${miranda_out_file}
