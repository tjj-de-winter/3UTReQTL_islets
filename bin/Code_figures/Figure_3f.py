...
plot_data = {
    '1': ['PTEN', '10:87966988', 'beta-cells', 'healthy'],
    '2': ['PTEN', '10:87966988', 'beta-cells', 'T2D']
}
...
for idx in plot_data:
    ...
    plot(gene, chromosome, variant, celltype, group, hex_to_rgb(color), nameout=f'figure3f_{idx}.png', fontsize=14, set_ylim=True, ylim=(-0.25,5.5))