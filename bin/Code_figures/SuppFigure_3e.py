...
values = list(df_ct_norm.loc['hsa-miR-127-5p'])
scatter = ax.scatter(df.loc[0,:], df.loc[1,:],s = 50, c = values, cmap='viridis', edgecolor='black')
...
colorbar.set_label('normalized expression')
ax.set_title('miR-127-5p')
