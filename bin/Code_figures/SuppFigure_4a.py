...
fig, ax = boxplot_activity(acts_sub, 'NFkB', title='ND beta-cells',groupby='alleles',groups=['T/T', 'T/C', 'C/C'], estimate='mlm_estimate',color=(227, 119, 194))
