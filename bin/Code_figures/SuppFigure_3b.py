...
plot_data = {
    '1': ['SNX27', '1:151698114', 'beta-cells', 'healthy'],
    '2': ['SNX27', '1:151698114', 'beta-cells', 'T2D']
}
...
for idx in plot_data:
    ...
    plot(gene, chromosome, variant, celltype, group, hex_to_rgb(color), nameout=f'supp_figure3b_{idx}.png', fontsize=14, set_ylim=False)