...
filenameout = 'figure2e.png'
filenameout_anno = 'figure2e_annotations.png'
...
fig, ax = shared_unique_eqtls_plot(df_eqtl_beta_T2D, df_eqtl_alpha_ND, '\nbeta-cell T2D', 'alpha-cell ND\n(downsampled)', 
