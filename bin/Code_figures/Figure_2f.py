...
filenameout = 'figure2f.png'
filenameout_anno = 'figure2f_annotations.png'
...
fig, ax = shared_unique_eqtls_plot(df_eqtl_beta_ND, df_eqtl_alpha_ND, '\nbeta-cell ND', 'alpha-cell ND\n(downsampled)', 
