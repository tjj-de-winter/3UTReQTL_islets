...
filenameout1 = 'figure5f_1.png'
filenameout2 = 'figure5f_2.png'
...
fig, ax = boxplot_activity(acts_sub, 'EGFR', title='ND beta-cells',groupby='alleles',set_ylim=True,ylim=(-3.5,3.5), groups=['T/T', 'T/C', 'C/C'], estimate='mlm_estimate',color=(227, 119, 194))
...
fig, ax = boxplot_activity(acts_sub, 'EGFR', title='T2D beta-cells',groupby='alleles',set_ylim=True,ylim=(-3.5,3.5), groups=['T/T', 'T/C', 'C/C'], estimate='mlm_estimate',color=(227, 119, 194))
