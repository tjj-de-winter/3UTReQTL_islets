...
filenameout1 = 'figure5h_1.png'
filenameout2 = 'figure5h_2.png'
...
acts_sub = get_adata_sub(acts, geno, 'beta-cells', 'healthy')

fig, ax = boxplot_activity(acts_sub, 'FOXO3', title='ND beta-cells',groupby='alleles', set_ylim=True, ylim=(-0.75,6.25),groups=['T/T', 'T/C', 'C/C'], estimate='ulm_estimate',color=(227, 119, 194))
...
acts_sub = get_adata_sub(acts, geno, 'beta-cells', 'T2D')

fig, ax = boxplot_activity(acts_sub, 'FOXO3', title='T2D beta-cells',groupby='alleles', groups=['T/T', 'T/C', 'C/C'], set_ylim=True, ylim=(-0.75,6.25),estimate='ulm_estimate',color=(227, 119, 194))
