...
filenameout = 'figure2b.png'
filenameout_anno = 'figure2b_annotations.png'
...
fig, ax = shared_unique_eqtls_plot(df_eqtl_beta_ND, df_eqtl_beta_T2D, 'beta-cell ND', 'beta-cell T2D', fontsize=10,
                         xlim=(-1,17), ylim=(-1,17), text=False)

fig.savefig(filenameout, bbox_inches='tight')

fig, ax = shared_unique_eqtls_plot(df_eqtl_beta_ND, df_eqtl_beta_T2D, 'beta-cell ND', 'beta-cell T2D', fontsize=10,
                         xlim=(-1,17), ylim=(-1,17), text=True)
